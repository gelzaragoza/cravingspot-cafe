            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
						...
						<li class="divider"></li>
						<li><a href="#edit_profile" data-toggle="modal"><span class="glyphicon glyphicon-user"></span>  Update Profile</a></li>
						<li class="divider"></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="sales_report.php"><i class="fa fa-files-o fa-fw"></i> Sales Report</a>
                        </li>
						<li><a href="#logout" data-toggle="modal"><i class="fa fa-sign-out fa-fw"></i> Logout</a></li>
                    </ul>
                </div>
