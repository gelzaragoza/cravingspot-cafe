            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
					...
					<div class="col-lg-2 pull-right noprint">
						...
						<a href="inventory_report.php" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
					</div>					
				</div>
				</div>
				<br>
                ...
                <div class="col-lg-12">
                    <table width="100%" class="table table-bordered" style="font-size:13px;">
						...
						<tbody>
							<?php
								$iq=mysqli_query($con,"select * from inventory left join employee_backup on employee_backup.userid=inventory.userid left join product_backup on product_backup.productid=inventory.productid left join user_backup on user_backup.userid=inventory.userid left join emp_position on emp_position.positionid=employee_backup.positionid where date(inventory.inv_date) between '$inv_from' and '$inv_to' order by inv_date desc");
