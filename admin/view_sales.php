            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <table width="100%" class="table table-bordered" style="font-size:13px;">
						...
						<tbody>
							<?php
								$salesq=mysqli_query($con,"select * from sales left join dealer_backup on dealer_backup.userid=sales.userid where date(sales_date) between '$sales_from' and '$sales_to'");
