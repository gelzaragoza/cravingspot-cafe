			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					?>
						...
						<tbody>
						<tr>
							<td width="150px;"><strong><?php echo isset($pmrow['prod_name']) ? $pmrow['prod_name'] : ''; ?></strong></td>
							<td><span class="label label-default pull-right"><?php echo isset($pmrow['total_qty']) ? $pmrow['total_qty'] : ''; ?></span></td>
						</tr>
						</tbody>
						</table>
					</div>
					...
					?>
						...
						<tbody>
						<tr>
							<td width="140px;"><strong><?php echo isset($mdrow['firstname']) ? ucwords($mdrow['firstname'].' '.$mdrow['lastname']) : ""; ?></strong></td>
							<td><span class="label label-default pull-right"><?php echo isset($mdrow['total_purchase']) ? number_format($mdrow['total_purchase'],2) : ''; ?></span></td>
						</tr>
						</tbody>
						</table>
					</div>
